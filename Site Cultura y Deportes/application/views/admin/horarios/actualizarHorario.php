...
<?php foreach($horario as $horario){ ?>
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" id="hora" name="hora" value = "<?php echo $horario->hora; ?>">
  </div>

  <div class="input-group">
    <span class="input-group-addon glyphicon glyphicon-lock"></span>
  <input type="text" class="form-control" id="dia" name="dia"  value = "<?php echo $horario->dia; ?>">
    </div>

    <div class="input-group">
      <span class="input-group-addon glyphicon glyphicon-lock"></span>
    <input type="text" class="form-control" id="lugar" name="lugar"  value = "<?php echo $horario->lugar; ?>">
      </div>

      <div class="input-group">
        <span class="input-group-addon glyphicon glyphicon-lock"></span>
      <input type="text" class="form-control" id="cuatrimestre" name="cuatrimestre"  value = "<?php echo $horario->cuatrimestre; ?>">
        </div>
