        ...
        <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="row">
                ...
                <table class="table  table-responsive table-striped table-hover table-bordered" >
                    <tr>
                        <td colspan="1" ><a href="<?php echo base_url(); ?>index.php/CPProfesor/Coro/frmAlumno" class="btn btn-info">Agregar</a></td>
                        <td colspan="1" ><a href="<?php echo base_url(); ?>index.php/CPProfesor/Coro/tuXML" class="btn btn-success">Descargar XML</a></td>
                        <td colspan="1" ><a href="<?php echo base_url(); ?>index.php/CPProfesor/Coro/tuExel" class="btn btn-success">Descargar Exel</a></td>
                    </tr>
