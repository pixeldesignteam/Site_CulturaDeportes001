<div class="col-sm-6 col-sm-offset-2" >
    ...
    <?php echo form_open('CPProfesor/Bguerra/addAlumno'); ?>
        ...
        <div class="form-group">
            <a href="<?php echo base_url(); ?>index.php/CPProfesor/Bguerra/bguerra"> <input type="button"  name="submit"  value="Cancelar" class="btn btn-danger btn-lg"  required="required" > </a>
        </div>
