...
<table class="table table-bordered table-hover">
  ...
  <tr class="success" ><td colspan="9" ><a class="btn btn-success" href="nuevoHistorial">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Historiales/tuXML/Lista">XML</a></td></tr>
    <tr class="danger">
        <td>Alergias</td>
...
if(isset($historial)){
    foreach ($historial as $historial){
        echo "<tr class='success'><td>" .$historial->alergias . "</td>" .
            "<td>" . $historial->enfermedades. "</td>" .
            "<td>" . $historial->altura. "</td>" .
            "<td>" . $historial->peso. "</td>" .
            "<td>" . $historial->sangre. "</td>" .
            "<td>" . $historial->idAlumno. "</td>" .


            "<td>";
            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarHistorial/$historial->idHistorial'>Modificar</a></td>"
                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delHistorial/$historial->idHistorial' >Eliminar</a></td></tr>";
    }
}else{
    echo "Sin registros";
}
