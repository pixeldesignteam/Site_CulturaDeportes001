  ...
  <header id="INICIO" style="background-position: 50% -125px;">
      <div class="section_overlay">
          ...
          <table class="table table-bordered table-hover">
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoCoro">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Coro/tuXML/Lista">XML</a></td></tr>
                    <tr class="danger">
                        <td>Matricula</td>
                        <td>Foto</td>
                        <td>Nombre</td>
                ...
                <?php
                if(isset($coro)){
                    foreach ($coro as $coro){
                        echo "<tr class='success'><td>" .$coro->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$coro->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $coro->nombre_alumno . "</td>" .
                            ...
                            "<td>" . $coro->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarCoro/$coro->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delCoro/$coro->id_alumno' >Eliminar</a></td></tr>";
