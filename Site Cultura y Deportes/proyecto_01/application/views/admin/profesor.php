...
<table class="table table-bordered table-hover">
    ...
    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoProfe">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Profesores/tuXML/Lista">XML</a></td></tr>
    <tr class="danger">
        <td>Matricula</td>
        <td>Foto</td>
        <td>Nombre</td>
...
if(isset($profesor)){
    foreach ($profesor as $profesor){
        echo "<tr class='success'><td>" .$profesor->matricula . "</td>" .
        "<td>";?> <img src="<?php echo base_url().'upload/'.$profesor->foto ?>" width="150" height="150"> </td>
            <?php echo "<td>" . $profesor->nombre . "</td>" .
            "<td>" . $profesor->password . "</td>" .
            "<td>" . $profesor->direccion. "</td>" .
            "<td>" . $profesor->telefono. "</td>" .
            "<td>" . $profesor->privilegios. "</td>" .
            "<td>" . $profesor->email. "</td>" .
            "<td>";
            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarProfe/$profesor->idProfesor'>Modificar</a></td>"
                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delProfe/$profesor->idProfesor' >Eliminar</a></td></tr>";
    }
}else{
    echo "Sin registros";
}
