        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="WORK_TITLE wow fadeInUp animated">
                    ...
                    <h2>Artes Plasticas</h2>
                    <img src="<?php echo base_url();?>images/shape.png" alt="">
                </div>
                <table class="table table-bordered table-hover">

                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoArte">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Plasticas/tuXML/Lista">XML</a></td></tr>
                ...
                <?php
                if(isset($arte)){
                    foreach ($arte as $arte){
                        echo "<tr class='success'><td>" .$arte->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$arte->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $arte->nombre_alumno . "</td>" .
                            "<td>" . $arte->direccion. "</td>" .
                            "<td>" . $arte->telefono. "</td>" .
                            "<td>" . $arte->email. "</td>" .
                            "<td>" . $arte->carrera. "</td>" .
                            "<td>" . $arte->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarArte/$arte->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delArte/$arte->id_alumno' >Eliminar</a></td></tr>";
