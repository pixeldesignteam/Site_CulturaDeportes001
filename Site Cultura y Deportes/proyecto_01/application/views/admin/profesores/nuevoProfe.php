...
<div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms">
  ...
  <br>
  <div class="form-body">
<?php echo form_open_multipart('CA/Profesores/addProfe');?>
...
<div class="form-group">
  <input type="text" name="direccion" class="form-control" id="inputName" placeholder="Password" required>
</div>
<div class="form-group">
...
<div class="form-group">
  <input type="text" name="privilegios" class="form-control" id="inputName" placeholder="Privilegios" required>
</div>
