...
<div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms">
  ...
  <div class="row">
    <tr class="success" ><td colspan="2" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Escolta/getAlumno">Regresar</a></td></tr>
  </div>
  <br>
  <div class="form-body">
    <?php echo form_open_multipart('CA/Escolta/addAlumno');?>
