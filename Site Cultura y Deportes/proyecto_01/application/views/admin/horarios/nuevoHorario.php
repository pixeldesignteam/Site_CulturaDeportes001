...
<div class="form-group">
  <input type="text" name="hora" class="form-control" id="inputName" placeholder="Horario" required>
</div>
<div class="form-group">
  <input type="text" name="dia" class="form-control" id="inputName" placeholder="Día" required>
</div>
<div class="form-group">
  <input type="text" name="cuatrimestre" class="form-control" id="inputName" placeholder="Cuatrimestre" required>
</div>
