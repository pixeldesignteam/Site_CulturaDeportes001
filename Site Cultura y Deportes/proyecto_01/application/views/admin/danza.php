  ...
  <header id="INICIO" style="background-position: 50% -125px;">
      <div class="section_overlay">
          ...
          <table class="table table-bordered table-hover">
                    ...
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Danza/tuXML/Lista">XML</a></td></tr>
                    <tr class="danger">
                        <td>Matricula</td>
                        <td>Foto</td>
                        <td>Nombre</td>
                ...
                if(isset($alumno)){
                    foreach ($alumno as $alumno){
                        echo "<tr class='success'><td>" .$alumno->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$alumno->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $alumno->nombre_alumno . "</td>" .
                            ...
                            "<td>" . $alumno->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarAlumno/$alumno->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delAlumno/$alumno->id_alumno' >Eliminar</a></td></tr>";
