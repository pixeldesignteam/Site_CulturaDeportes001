...
<table class="table table-bordered table-hover">
    ...
    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoTaller">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Talleres/tuXML/Lista">XML</a></td></tr>
    <tr class="danger">
        <td>Nombre</td>
        <td>Descripcion</td>
...
if(isset($taller)){
    foreach ($taller as $taller){
        echo "<tr class='success'><td>" .$taller->nombreTaller . "</td>" .
            "<td>" . $taller->direccion. "</td>" .

            "<td>";
            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarTaller/$taller->idTaller'>Modificar</a></td>"
                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delTaller/$taller->idTaller' >Eliminar</a></td></tr>";
    }
}else{
    echo "Sin registros";
}
