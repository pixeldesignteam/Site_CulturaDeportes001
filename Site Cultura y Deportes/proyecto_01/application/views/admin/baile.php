                  ...
                  <div class="row">
                      <div class="col-md-12 text-center">
                          <div class="WORK_TITLE wow fadeInUp animated">
                              <h2>BAILE DE SALÓN</h2>
                              <img src="<?php echo base_url();?>images/shape.png" alt="">
                          </div>
          <table class="table table-bordered table-hover">
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoBaile">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Baile/tuXML/Lista">XML</a></td></tr>
                    <tr class="danger">
                        <td>Matricula</td>
                        <td>Foto</td>
                        <td>Nombre</td>
                ...
                <?php
                if(isset($baile)){
                    foreach ($baile as $baile){
                        echo "<tr class='success'><td>" .$baile->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$baile->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $baile->nombre_alumno . "</td>" .
                            "<td>" . $baile->direccion. "</td>" .
                            "<td>" . $baile->telefono. "</td>" .
                            "<td>" . $baile->email. "</td>" .
                            "<td>" . $baile->carrera. "</td>" .
                            "<td>" . $baile->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarBaile/$baile->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delBaile/$baile->id_alumno' >Eliminar</a></td></tr>";
