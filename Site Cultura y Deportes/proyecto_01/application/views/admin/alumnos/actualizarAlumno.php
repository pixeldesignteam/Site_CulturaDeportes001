...
<body>
  ...
  <div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms">
    ...
    <br>
<?php echo form_open_multipart('CA/Alumnos/upAlumno');?>
<?php foreach($alumno as $alumno){ ?>
    ...
    <div class="form-group">
      <input type="text" name="nombreAlumno" class="form-control" value="<?php echo $alumno->nombreAlumno; ?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <input type="text" name="carrera" class="form-control" value="<?php echo $alumno->carrera; ?>" required>
    </div>
    ...
    <label  for="beca">Beca</label>
      <center><div class="form-group input-group">
        <select required name="nombreBeca">
        <option value=""><?php echo $alumno->nombreBeca; ?></option>
        <option value="NINGUNA">NINGUNA</option>
        <option value="iNTERNA">INTERNA</option>
        <option value="MANUTENCIÓN">MANUTENCIÓN</option></center>
    </select>
    </div>
    <div class="form-group">
