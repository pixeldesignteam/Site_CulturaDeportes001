...
<br>
<?php echo form_open('CA/Lugares/addLugar');?>
<div class="form-group">
  <input type="text" name="nombreLugar" class="form-control" id="inputName" placeholder="Nombre del Lugar" required>
</div>
<div class="form-group">
  <input type="text" name="direccion" class="form-control" id="inputName" placeholder="Direccion" required>
</div>
<div class="form-group">
  <input type="text" name="idTaller" class="form-control" id="inputName" placeholder="Taller" required>
</div>
