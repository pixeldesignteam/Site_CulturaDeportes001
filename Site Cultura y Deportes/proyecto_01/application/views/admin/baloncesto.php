  ...
  <header id="INICIO" style="background-position: 50% -125px;">
      <div class="section_overlay">
          ...
          <table class="table table-bordered table-hover">
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevoBalon">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Baloncesto/tuXML/Lista">XML</a></td></tr>
                    <tr class="danger">
                        <td>Matricula</td>
                        <td>Foto</td>
                        <td>Nombre</td>
                ...
                <?php
                if(isset($balon)){
                    foreach ($balon as $balon){
                        echo "<tr class='success'><td>" .$balon->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$balon->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $balon->nombre_alumno . "</td>" .
                            "<td>" . $balon->direccion. "</td>" .
                            "<td>" . $balon->telefono. "</td>" .
                            "<td>" . $balon->email. "</td>" .
                            "<td>" . $balon->carrera. "</td>" .
                            "<td>" . $balon->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarBalon/$balon->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delBalon/$balon->id_alumno' >Eliminar</a></td></tr>";
