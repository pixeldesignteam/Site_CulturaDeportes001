...
<div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms">
  ...
  <br>
  <div class="form-body">
    <?php echo form_open_multipart('CA/Baloncesto/addBalon');?>
      ...
      <div class="form-group">
        <input type="text" name="nombre_alumno" class="form-control" id="inputName" placeholder="Nombre" required>
      </div>
      <div class="form-group">
      ...
      <center><div class="form-group input-group">
        <select required name="nivel" required>
