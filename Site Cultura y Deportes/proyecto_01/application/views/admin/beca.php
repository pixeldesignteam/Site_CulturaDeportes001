...
<table class="table table-bordered table-hover">
    ...
    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevaBeca">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Beca/tuXML/Lista">XML</a></td></tr>
    <tr class="danger">
        <td>Nombre</td>
        <td>Descripcion</td>
...
if(isset($beca)){
    foreach ($beca as $beca){
        echo "<tr class='success'><td>" .$beca->nombreBeca . "</td>" .
            "<td>" . $beca->descripcion. "</td>" .

            "<td>";
            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarBeca/$beca->idBeca'>Modificar</a></td>"
                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delBeca/$beca->idBeca' >Eliminar</a></td></tr>";
    }
}else{
    echo "Sin registros";
}
