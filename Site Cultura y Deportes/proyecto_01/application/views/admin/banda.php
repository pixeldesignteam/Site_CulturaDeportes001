  ...
  <header id="INICIO" style="background-position: 50% -125px;">
      <div class="section_overlay">
          ...
          <table class="table table-bordered table-hover">
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="nuevaBanda">Nuevo</a></td></tr>
                    <tr class="success" ><td colspan="9" ><a class="btn btn-success"  href="<?php echo base_url();?>index.php/CA/Banda/tuXML/Lista">XML</a></td></tr>
                    <tr class="danger">
                        <td>Matricula</td>
                        <td>Foto</td>
                        <td>Nombre</td>
                ...
                if(isset($banda)){
                    foreach ($banda as $banda){
                        echo "<tr class='success'><td>" .$banda->matricula . "</td>" .
                           "<td>";?> <img src="<?php echo base_url().'upload/'.$banda->foto ?>" width="150" height="150"> </td>
                          <?php echo  "<td>" . $banda->nombre_alumno . "</td>" .
                            "<td>" . $banda->direccion. "</td>" .
                            "<td>" . $banda->telefono. "</td>" .
                            "<td>" . $banda->email. "</td>" .
                            "<td>" . $banda->carrera. "</td>" .
                            "<td>" . $banda->nivel. "</td>" .
                            "<td>";
                            echo "<td><a class='btn btn-warning btn-xs col-md-9 col-xs-6'  href='actualizarBanda/$banda->id_alumno'>Modificar</a></td>"
                                      . "<td><a class='btn btn-danger btn-xs col-md-9 col-xs-6' href='delBanda/$banda->id_alumno' >Eliminar</a></td></tr>";
