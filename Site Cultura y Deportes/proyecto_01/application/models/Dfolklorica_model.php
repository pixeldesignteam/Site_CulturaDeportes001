 ...
 * Time: 02:06 AM
 */
class Dfolklorica_model extends CI_Model
{
    ...
    public function upAlumno($id, $mat ,$nom, $dir, $tel, $email, $carr, $niv){
        ...
        $this->db->where('id_alumno', $id);
        $this->db->update('d_folklorica', $data);
    ...
    public function tuExel(){
        $fields = $this->db->field_data('d_folklorica');
        $this->db->order_by('id_alumno','asc');
        $query =$this->db->get('d_folklorica');
