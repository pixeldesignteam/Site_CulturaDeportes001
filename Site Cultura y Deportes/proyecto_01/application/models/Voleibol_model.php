 ...
 * Time: 02:06 AM
 */
class Voleibol_model extends CI_Model
{
    ...
    public function tuExel(){
        $fields = $this->db->field_data('voleibol');
        $this->db->order_by('id_alumno','asc');
        $query =$this->db->get('voleibol');
