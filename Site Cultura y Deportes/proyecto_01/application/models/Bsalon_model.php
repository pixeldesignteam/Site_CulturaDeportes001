 ...
 * Time: 02:06 AM
 */
class Bsalon_model extends CI_Model
{
    ...
    public function tuExel(){
        $fields = $this->db->field_data('b_salon');
        $this->db->order_by('id_alumno','asc');
        $query =$this->db->get('b_salon');
